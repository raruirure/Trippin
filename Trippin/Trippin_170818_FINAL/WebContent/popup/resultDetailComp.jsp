...
<body>
	<%
		...
		ReviewBean review2 = null;
		ReviewDAO reviewDAO = ReviewDAO.getInstance();
		reviewDAO.setConnection(conn);
		
		plan1 = planDAO.selectByCode(compCode1);
		review1 = reviewDAO.selectByCode(compCode1);
		plan2 = planDAO.selectByCode(compCode2);
		review2 = reviewDAO.selectByCode(compCode2);
	%>
	<div class="row" style="background: white;width:1000px;margin:0;">
				...
				<div class="card">
					<div class="card-image">
						<figure class="image is-4by3">
							<img src="<%=plan1.getBanner_img() %>" alt="">
						</figure>
					</div>
					<div class="card-content">
						<div class="content">
							<span class="tag is-dark"><%=plan1.getMain_title() %></span>
						</div>
					</div>
				</div>
            </div>
			...
			<div class="col-lg-4" style="width:300px;">
				<div class="card">
					<div class="card-image">
						<figure class="image is-4by3">
							<img src="<%=plan2.getBanner_img() %>" alt="">
						</figure>
					</div>
					<div class="card-content">
						<div class="content">
							<span class="tag is-dark"><%=plan2.getMain_title() %></span>
						</div>
					</div>
				</div>
            </div>
