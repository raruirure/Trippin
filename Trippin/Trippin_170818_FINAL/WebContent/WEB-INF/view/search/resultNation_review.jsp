        ...
        <div class="columns">
            <aside class="column is-2 aside hero is-fullheight is-hidden-mobile" style="width:300px;">
               ...
               <!-- category Parameter 추가  -->
                    <p><center><a href="review.main?category=asia">아시아</a><button class="nationBtn">▼</button></center></p>
                    <hr>
                    ...
                    <p><center><a href="review.main?category=europe">유럽</a><button class="nationBtn">▼</button></center></p>
                    <hr>
                    <div class="searchLand">
                        <ul>
                            <li><a href="">영국</a></li>
                    ...
                    <p><center><a href="review.main?category=oseania">오세아니아</a><button class="nationBtn">▼</button></center></p>
                    <hr>
                    <div class="searchLand">
                        <ul>
                            <li><a href="">호주</a></li>
                    ...
                    <p><center><a href="review.main?category=america">아메리카</a><button class="nationBtn">▼</button></center></p>
                    <hr>
                    <div class="searchLand">
                        <ul>
                            <li><a href="">미국</a></li>
                    ...
                    <p><center><a href="review.main?category=africa">아프리카</a><button class="nationBtn">▼</button></center></p>
                    <hr>
                    <div class="searchLand">
                        <ul>
                            <li><a href="">토고</a></li>
     				...
     				<form name = "list_order">
	            	    <select onchange="location.href=this.value;" id="boardSelect" class="board select"   style="height:40px;border-radius:5px;">
	                	 	<option value="">정렬순서</option>
	               	 		<option value="review.main?select=s1">좋아요별</option>
	               	 		<option value="review.main?select=s2">조회별</option>
	            		</select>
	            	</form>
	            	<!-- end -->
	            </div>
	        ...
	        <%
		        ...
		        ArrayList<ReviewBean> selectAll = (ArrayList<ReviewBean>)session.getAttribute("review");
		        
		        for(int i=0; i<selectAll.size();i++){
		        ReviewBean review = selectAll.get(i);
	        %>
               ...
               <div class="card plan">
                   <div class="card-image">
                    ...
                    <footer class="card-footer">
                       <a class="card-footer-item"><i class="mdi mdi-heart" style="font-size:24px;"><%=review.getHit() %></i></a>
