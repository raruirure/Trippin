    ...
    <div class="container" style="width:1200px;">
        <div class="columns">
            <aside class="column is-2 aside hero is-fullheight is-hidden-mobile" style="width:300px;">
               <div class="main" style="padding:0;">
				...
				<!-- category Parameter 추가  -->
                    <p><center><a href="product.main?category=asia">아시아</a><button class="nationBtn">▼</button></center></p>
                    <hr>
                    ...
                    <p><center><a href="product.main?category=europe">유럽</a><button class="nationBtn">▼</button></center></p>
                    <hr>
                    <div class="searchLand">
                        <ul>
                            <li><a href="">영국</a></li>
                    ...
                    <p><center><a href="product.main?category=oseania">오세아니아</a><button class="nationBtn">▼</button></center></p>
                    <hr>
                    <div class="searchLand">
                        <ul>
                            <li><a href="">호주</a></li>
                    ...
                    <p><center><a href="product.main?category=america">아메리카</a><button class="nationBtn">▼</button></center></p>
                    <hr>
                    <div class="searchLand">
                        <ul>
                            <li><a href="">미국</a></li>
                    ...
                    <p><center><a href="product.main?category=africa">아프리카</a><button class="nationBtn">▼</button></center></p>
                    <hr>
                    <div class="searchLand">
                        <ul>
                            <li><a href="">토고</a></li>
     				...
     				<form name = "list_order">
	            	    <select onchange="location.href=this.value;" id="boardSelect" class="board select"   style="height:40px;border-radius:5px;">
	                	 	<option value="">정렬순서</option>
	               	 		<option value="product.main?select=s1">좋아요별</option>
	               	 		<option value="product.main?select=s2">조회별</option>
	            		</select>
	            	</form>
	            	<!-- end -->
	            </div>
	        ...
	        <%
		        ...
		        ArrayList<ProductVo> selectAll = (ArrayList<ProductVo>)session.getAttribute("product");
		        
		        for(int i=0; i<selectAll.size();i++){
		        	ProductVo product = selectAll.get(i);
	        %>	
	            <div class="col-lg-4 plan" style="width:300px;">
					<div class="card">
                          ...
                          %>
                             <img src="images/upload/product/<%=product.getPro_img() %>" alt="">
                          <%      
                             }else{
                          %>
		                  ...
		                  <div class="card-content" style="height:60px;line-height: 60px;">
		                     <div class="content">
		                         <span class="tag is-dark"><%=product.getPro_name() %></span>
		                     </div>
		                  </div>
		                  <footer class="card-footer">
		                       <a class="card-footer-item"><i class="mdi mdi-heart" style="font-size:24px;"><%=product.getPro_hit() %></i></a>
