...
<body>
	...
	<div class="container review_form">
		...
		<div class="section review_view_heading">
			<div class="columns">
				<div class="column">
					<div class="review_name box"><%=plan.getMain_title() %></div>
				</div>
		...
		<!-- 기간 지정 -->
			<div class="review_form_date columns">
				...
				<div class="column is-3">
					<input class="input" type="text" placeholder="Disabled input" value="<%=plan.getSdate() %>" disabled>
				</div>
				<div class="column is-1">
					<div class="title review_form_date_tilde">~</div>
				</div>
				<div class="column is-3">
					<input class="input is-one-quarter" type="text" placeholder="Disabled input" value="<%=plan.getEdate() %>" disabled>
				</div>
			</div>
					...
					<div class="box review_form_content_route">
						<table class="review_plan_view_content_detail">
							...
							<tr class="detail_form">
								<td colspan="2"><%=plan.getPlan_content() %></td>
							</tr>
						</table>
					</div>
				</div>
		...
		<%
			...
			if(plan.getUser_id().equals(member.getUserId())){
		%>
		<button class="button review_form_btn review_btn_right" onclick="location.href='planDelete.con?code=<%=plan.getCode()%>'">삭제</button>
		<button class="button review_form_btn review_btn_right" onclick="location.href='planUpdate.con?code=<%=plan.getCode()%>'">수정</button>
		<%
			}
		%>
		<button class="button review_form_btn review_btn_right" onclick="location.href='user_plan.mypage'">목록</button>
