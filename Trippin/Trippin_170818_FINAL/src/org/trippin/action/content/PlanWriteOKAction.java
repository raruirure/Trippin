...
public class PlanWriteOKAction implements Action {
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		PlanBean plan = null;
		PlanWriteService planWriteService = new PlanWriteService();
		...
		String code_class = "P";
		int write_no = planWriteService.getCount();
		...
		try {
			isWriteSuccess = planWriteService.registPlan(plan);
		} catch (Exception e) {
