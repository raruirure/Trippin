...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	MessageVo vo = (MessageVo)request.getAttribute("messageNDetail");
%>
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
  ...
  <link rel="stylesheet" type="text/css" href="css/messages/message_content.css">
</head>
<body>
<page>  
  <div class="container"> 
      ...
      <div id="table" style="width:780px; margin-left:10px;">
        <table class="table is-bordered">
         ...
         <div id="message_send">
          <a class="button is-primary board" href="NormalDelete.msg?idx=<%=vo.getNo() %>">삭제</a>
